<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px">
	<!-- Main star shape with yellow fill -->
	<path
		...
		fill="currentColor"
	/>
	<!-- Overlay paths (kept unfilled or with default styling) -->
	<path d="m354-635-194 64 124 179-4 191 200-55 200 56-4-192 124-177-194-66-126-165-126 165Zm126 135Z" />
</svg>
