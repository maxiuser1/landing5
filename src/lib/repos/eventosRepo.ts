...
export class EventosRepo implements App.EventosRepoInterface {
	...
	getEventosDestacados = async (): Promise<Array<App.Evento> | undefined> => {
		...
		const querySpec: SqlQuerySpec = {
			query: 'SELECT c.banner, c.card, c.slug, c.fechas,c.nombre,c.artista,c.lugar, c.desde, c.descuento, c.descontado, c.ciudad FROM c WHERE c.destacado and c.publicado = true'
		};
